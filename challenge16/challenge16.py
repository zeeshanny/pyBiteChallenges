...
first will be accessed first. A real-world example of queue can be a
...
bus-stops. [source]
Complete the queue function to return a queue-like data type that keeps
the last n items.

Check the standard library to see how you can do this in the shortest/most
efficient way.
"""
