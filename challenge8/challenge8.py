...
that filters out the items in the set and returns the resulting dict, so
if your dict is {1: 'bob', 2: 'julian', 3: 'tim'} and your set is {2, 3},
...
def filter_bites(bites=bites, bites_done=exclude_bites):
    ...
    # for key in list(bites.keys()):
    #     if key in exclude_bites:
    #         del bites[key]
    # return bites
